...
public class webtoonDTO{
	...
	private String webtoon_img;
	private String webtoon_link;
	private String webtoon_keyword;
	
	public webtoonDTO(String webtoon_seq, String webtoon_name, String webtoon_writer, String webtoon_content,
			String webtoon_genre, String webtoon_img, String webtoon_link, String webtoon_keyword) {
		super();
	...
	public webtoonDTO(String webtoon_name, String webtoon_writer, String webtoon_content, String webtoon_genre,
			String webtoon_img, String webtoon_link, String webtoon_keyword) {
		super();
		this.webtoon_name = webtoon_name;
		this.webtoon_writer = webtoon_writer;
		this.webtoon_content = webtoon_content;
	...
	public webtoonDTO(String webtoon_seq) {
		super();
		this.webtoon_seq = webtoon_seq;
	}
	...
	public String getWebtoon_img() {
		return webtoon_img;
	}

	public void setWebtoon_img(String webtoon_img) {
		this.webtoon_img = webtoon_img;
	}
